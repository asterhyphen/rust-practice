...
pub fn shortest_path() {
    ...
    let ix_factory = graph.add_node("LX Factory");
    ...
    graph.extend_with_edges([
        ...
        (belem_tower, ix_factory, 3), // The distance from Belem Tower to LX Factory is 3 km
        (belem_tower, commerce_square, 7), // The distance from Belem Tower to Commerce Square is 7 km
        (monastery, ix_factory, 3), // The distance from Jerónimos Monastery to LX Factory is 3 km
